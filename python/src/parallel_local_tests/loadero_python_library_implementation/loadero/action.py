...
def backup_handler(obj, loadero_test_ids, args_suite, args_test_ids, args_overwrite_suite):
    ...
    # Only test_ids provided, overwrite_suite False
    if args_test_ids and not args_suite:
        test_ids = local_manager.validate_cli_test_ids(loadero_test_ids, args_test_ids)
    # Only test_ids provided, overwrite_suite True
    elif args_test_ids and not args_suite and args_overwrite_suite is True:
    ...
    # Test ids and suites provided, overwrite_suite False
    ...
    # Test ids and suites provided, overwrite_suite True
    elif args_test_ids and args_suite and args_overwrite_suite is True:
        test_ids_conf = local_manager.read_project_from_file(
            local_project_id, local_project_name)["manager_config"]["suites"][args_suite]["test_ids"]
    ...
    # Only overwrite_suite True
    elif not args_test_ids and not args_suite and args_overwrite_suite is True:
        logger.critical("You must provide suite name to be overwritten! Action denied!")
    else:
