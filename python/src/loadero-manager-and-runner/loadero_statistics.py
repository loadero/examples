    ...
    try:
        ...
        if len(test_ids) > 0:
            ...
            for test_id in test_ids:
                ...
                # Test asserts for particular test_id
                test_asserts = rm.read_all_asserts(test_id)
                # Test runs results for particular test_id
